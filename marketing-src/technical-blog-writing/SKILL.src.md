...
- 2026-06-02: Added explicit Readability gates + Rich formatting Hard Rule sections with measurable numbers (words/paragraph ≤ 60, VBD ≥ 12 per 1k words, subhead every 200-300 words). User asked for the published-in-domain readability test to be made operational.
...
- 2026-09-09: Replaced the ambiguous `repo` shorthand with the mandatory `source-repo` full URL required by build-system 2.0.0.
-->
